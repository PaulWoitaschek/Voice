...
* Use commits with a good description (preferrably using an established format like [Conventional Commit](https://www.conventionalcommits.org/en/), so everyone can see, what you did
