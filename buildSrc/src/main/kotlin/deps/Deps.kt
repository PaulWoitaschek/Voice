...
object Versions {
  ...
  const val versionCode = 3060301
  const val versionName = "4.0.0-nightly"
}
...
object Deps {
  ...
  const val androidGradlePlugin = "com.android.tools.build:gradle:3.2.0"
  ...
  object ExoPlayer {
    ...
    const val flac =
      "com.github.PaulWoitaschek.ExoPlayer-Extensions:flac:2.7.0-1"
  }
  ...
  object Kotlin {
    ...
    private const val versionCoroutines = "0.26.1"
