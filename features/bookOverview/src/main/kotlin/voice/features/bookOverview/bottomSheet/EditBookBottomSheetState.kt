...
enum class BottomSheetItem(
  ...
  PlayNext(StringsR.string.book_category_action_play_next, VoiceIcons.SkipNext),
  RemoveFromUpNext(StringsR.string.book_category_action_remove_up_next, VoiceIcons.Remove),
