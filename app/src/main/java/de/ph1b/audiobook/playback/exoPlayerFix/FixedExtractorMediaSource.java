...
/**
 * ### NOTE
 * This is the same as the upstream class but uses FixedExtractorMediaPeriod
 * ###
 * <p>
...
public final class FixedExtractorMediaSource extends BaseMediaSource
    implements FixedExtractorMediaPeriod.Listener {
  ...
  public FixedExtractorMediaSource(
      Uri uri,
  ...
  private FixedExtractorMediaSource(
      Uri uri,
      DataSource.Factory dataSourceFactory,
      ExtractorsFactory extractorsFactory,
  ...
  public MediaPeriod createPeriod(MediaPeriodId id, Allocator allocator) {
    ...
    return new FixedExtractorMediaPeriod(
        uri,
        dataSource,
  ...
  public void releasePeriod(MediaPeriod mediaPeriod) {
    ((FixedExtractorMediaPeriod) mediaPeriod).release();
  }
  ...
  // FixedExtractorMediaPeriod.Listener implementation.

  /**
   * Listener of {@link FixedExtractorMediaSource} events.
   *
  ...
  /**
   * Factory for {@link FixedExtractorMediaSource}s.
   */
  public static final class Factory implements AdsMediaSource.MediaSourceFactory {
    ...
    /**
     * Creates a new factory for {@link FixedExtractorMediaSource}s.
     *
     * @param dataSourceFactory A factory for {@link DataSource}s to read the media.
     */
    ...
    /**
     * Returns a new {@link FixedExtractorMediaSource} using the current parameters.
     *
     * @param uri The {@link Uri}.
     * @return The new {@link FixedExtractorMediaSource}.
     */
    @Override
    public FixedExtractorMediaSource createMediaSource(Uri uri) {
      isCreateCalled = true;
      if (extractorsFactory == null) {
        extractorsFactory = new DefaultExtractorsFactory();
      }
      return new FixedExtractorMediaSource(
          uri,
          dataSourceFactory,
          extractorsFactory,
     ...
     */
    @Deprecated
    public FixedExtractorMediaSource createMediaSource(
        Uri uri, @Nullable Handler eventHandler, @Nullable MediaSourceEventListener eventListener) {
      FixedExtractorMediaSource mediaSource = createMediaSource(uri);
