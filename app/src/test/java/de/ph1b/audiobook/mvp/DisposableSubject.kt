...
class DisposableSubject(failureMetadata: FailureMetadata, actual: Disposable?) : Subject<DisposableSubject, Disposable>(failureMetadata, actual) {
  ...
  companion object {
    val factory = Factory<DisposableSubject, Disposable> { metadata, actual -> DisposableSubject(metadata, actual) }
  }
}
