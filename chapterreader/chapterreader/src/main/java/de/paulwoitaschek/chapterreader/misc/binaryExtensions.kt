...
internal fun InputStream.skipBytes(number: Int) = IOUtils.skipFully(this, number.toLong())

internal fun InputStream.readAmountOfBytes(number: Int): ByteArray {
...
internal fun InputStream.readUInt8(): Int {
  val res = read()
...
internal fun Byte.toULong() = toLong() and 0xFFL
